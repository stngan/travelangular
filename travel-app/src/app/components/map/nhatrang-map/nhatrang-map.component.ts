...
@Component({
  selector: 'app-nhatrang-map',
  templateUrl: './nhatrang-map.component.html',
  styleUrls: ['./nhatrang-map.component.css']
})
export class NhatrangMapComponent {
  private map?: H.Map;
    ...
    if (!this.map && this.mapDiv) {
      ...
      const map = new H.Map(
        this.mapDiv.nativeElement, (layers as any).vector.normal.map,
        {
          ...
          center: { lat: 12.24507, lng: 109.19432 },
          zoom: 6.753214837,
        },
      );
      ...
      const landmarks = [
        {name: 'Nha Trang', lat: 12.24507, lng: 109.19432 },
