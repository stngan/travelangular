...
@Component({
  selector: 'app-hcm-map',
  templateUrl: './hcm-map.component.html',
  styleUrls: ['./hcm-map.component.css']
})
export class HcmMapComponent {
  private map?: H.Map;
  ...
  ngAfterViewInit(): void {
    if (!this.map && this.mapDiv) {
      ...
      const landmarks = [
        {name: 'Ho Chi Minh', lat: 10.762622, lng: 106.660172 },
